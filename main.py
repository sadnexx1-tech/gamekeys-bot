...
load_dotenv()
BOT_TOKEN = os.getenv("BOT_TOKEN", "8551467220:AAEYGoKd4P5wbVM3UwLOYQNFeW7xuxTWDrA")
YOOKASSA_SHOP_ID = os.getenv("YOOKASSA_SHOP_ID")
YOOKASSA_SECRET = os.getenv("YOOKASSA_SECRET")
ADMIN_ID = int(os.getenv("ADMIN_ID", 0))
TELEGRAM_CHANNEL_ID = int(os.getenv("TELEGRAM_CHANNEL_ID", "-1001331881336"))
CHANNEL_USERNAME = "frexgames"
...
async def create_payment(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        payment = Payment.create({
            ...
            "confirmation": {
                "type": "redirect",
                "return_url": "https://t.me/frexgames"
            },
